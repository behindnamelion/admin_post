...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post notices_url, params: { notice: { body: @notice.body, isshown: @notice.isshown, noticetime: @notice.noticetime, title: @notice.title } }
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { body: @notice.body, isshown: @notice.isshown, noticetime: @notice.noticetime, title: @notice.title } }
